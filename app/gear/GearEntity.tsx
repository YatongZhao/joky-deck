...
export const GearEntity = forwardRef<SVGPathElement, GearEntityProps>(function GearEntity({ transform, teeth, module, withHole, fillColor, active, onClick }: GearEntityProps, ref) {
